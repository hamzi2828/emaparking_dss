...
function getDateTimefomat($value) {
    return \Carbon\Carbon::parse($value)->format('j F, Y H:i');

}

function formatFieldNames($string) {

// Explode the string at underscores
...
// Join the capitalized words back into a string
    ...
    return $result; // Output: Vehicle Registration
}
    ...
    function getNotify()
    {
        ...
        if(is_admin()){
            if (Auth::id() == 1) {
                ...
                $checkNotify = \App\Models\DriverNotifications::query();
            }
        }else{
        ...
        if (Auth::id() == 1) {
            ...
            $countUnread = $checkNotify->count();
            $page = 'driver';
        }

        return [$notifications,$countUnread,$page];
    }

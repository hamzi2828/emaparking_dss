...
@else
    @php
        if(!empty($page_title)){
            ...
            {
                $page_title ="Restore your access to Midlands Parking";
            }elseif(request()->route()->getName()=='login'){

                $page_title ="Login to access to Midlands Parking";
            }else
            {
               $page_title = setting_item_with_lang('site_title' ,false,'My Travel');
            }
        ...
        if(request()->route()->getName()=='password.request')
            {
                $description ="If you forgot your password, follow the verification process and reclaim your account.";
            }elseif(request()->route()->getName()=='login'){

                $description ="Midlands Parking Dashboard.";
            }else
            {

    ...
    <div class="mb-5 shadow-soft bg-white rounded-sm">
        <div class="pt-4 pb-5 px-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 mb-4">
                    <label class="form-label">
                        {{ __("Email ") }}<i data-toggle="tooltip" data-placement="top" class="icofont-info-circle" aria-label="You will receive booking confirmation on this email address." data-bs-original-title="You will receive booking confirmation on this email address."></i>
                    </label>
...
<!--                <div class="col-sm-6 mb-4">
                ...
                <div class="col-sm-6 mb-4 d-none">
                    ...
                    <input name="country" class="form-control" value="{{$user != null && $user->country ? $user->country: 'United Kingdom'}}">
                </div>
<!--                <div class="col-sm-6 mb-4">
                    <label class="form-label">
                        {{ __("City") }}
...
<!--                <div class="col">
            ...
            <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="vehicle_color">Colour</label>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="" id="flight_no" name="flight_no" required class="form-control"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="time" value="{{session()->get('arrival_time','12:00')}}" id="arrival_time" name="arrival_time" class="form-control"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="time" value="{{session()->get('departure_time','12:00')}}" id="departure_time" name="departure_time" class="form-control"/>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-12 mb-4">
                    ...
                    <div class="mb-3">
                        <div class="custom-control custom-checkbox d-flex align-items-center text-muted">
                            <input type="checkbox" checked class="custom-control-input" id="termsCheckbox" name="term_conditions">
                    ...
                    <button class="btn btn-primary w-100 rounded-sm transition-3d-hover font-size-16 font-weight-bold py-3" @click="doCheckout">{{__('Confirm & Pay Now')}}

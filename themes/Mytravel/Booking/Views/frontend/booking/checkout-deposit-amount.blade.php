    ...
    <div class="form-group-item">
        ...
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text border-width-1">{{__('Credit')}} {{ !empty(auth()->user()) ? App\User::find(auth()->user()->id)->balanceFloat : 0  }}</span>
            </div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="val convert_pay_now total">{{format_money(floatval($booking->deposit == null ? $booking->total : $booking->deposit))}}</div>
        </div>
    </div>
@endif

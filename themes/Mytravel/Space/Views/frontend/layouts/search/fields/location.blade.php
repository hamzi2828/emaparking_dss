		...
		<div class="">
			<div class="input-group border-bottom border-width-2 border-color-1 py-2">
				...
				<div class="g-map-place border-0 p-0 form-control  height-40 d-flex" >
					<input type="text" name="map_place" placeholder="Select a parking lot"  value="{{request()->input('map_place')}}" class="font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0">
		...
		<div class="">
			<div class="input-group border-bottom border-width-2 border-color-1 py-2">
				...
				<div class="smart-search border-0 p-0 form-control  height-40">
					<input type="text" class="smart-search-location parent_text  font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0" {{ ( empty(setting_item("space_location_search_style")) or setting_item("space_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Select parking airport")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"

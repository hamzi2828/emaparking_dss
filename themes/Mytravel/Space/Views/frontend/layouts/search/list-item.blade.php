...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="bravo-list-item">
            <div class="d-flex justify-content-between align-items-center mb-4 topbar-search row">
                <h1 class="col-lg-10 font-weight-bold mb-0 text-lh-1 mt-2">Meet and Greet Parking Options at East Midlands Airport</h1>

                <div class="col-lg-2 control mt-2">
...
.list-item .row {
    display: grid;
    grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); /* Adjust column size */
...
@endpush
coorect this to make equal height cards
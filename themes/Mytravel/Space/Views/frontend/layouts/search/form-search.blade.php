<form action="{{ route("space.search") }}" class="form bravo_form d-flex flex-xl-row justify-content-center py-2" method="get">
    <div class="">
        <div class="row d-block nav-select d-flex align-items-center">
            ...
            @if(!empty($space_search_fields))
                @foreach($space_search_fields as $field)
                    ...
                    <div class="col-md-{{ $field['field'] == 'location' ? '3' : '9' }} mb-4 mb-lg-0 text-left">
                        @switch($field['field'])
                            @case ('service_name')
    ...
    <div class="align-self-center mt-0 ml-3">

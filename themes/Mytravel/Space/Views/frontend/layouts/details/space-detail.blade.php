<div class="d-block d-md-flex flex-center-between align-items-start mb-3">
    <div class="mb-3">
        <div class="d-block d-md-flex flex-horizontal-center mb-2 mb-md-0">
            ...
            <h1 class=" font-weight-bold mb-1 mr-3">{!! clean($translation->title) !!}</h1>
...
<!--        <li class="list-group-item px-1 border-0">
            <span class="height-45 width-45 @if(!isset($bookingModal) || $bookingModal==false) border rounded border-width-2 @endif flex-content-center service-wishlist {{$row->isWishList()}}" data-id="{{$row->id}}" data-type="{{$row->type}}">

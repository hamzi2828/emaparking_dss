<div class="mb-4">
    <div class="bravo_single_book_wrap">
        <div class="bravo_single_book bravo_space_book_app_{{$row->id}}" v-cloak>
            <div class="border border-color-7 rounded mb-5">
                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left">{{ __("Arrival - Departure") }}</span>
                        <div class="mb-4">

<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#booking-appends-{{$booking->id}}">
            {{__("Booking Appends")}}
        </a>
    </li>
    @endif
...
<div class="tab-content">
    ...
    @if(auth()->user()->role->id ==1)
        <div id="booking-appends-{{$booking->id}}" class="tab-pane fade">
            @include ($service->booking_append_info ?? 'Booking::frontend/booking/booking-append-info')
        </div>
    @endif

<form class="form bravo-form-register" method="post" action="{{route('auth.register.store')}}">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="input-group">
                <div class="input-group-text"><i class="input-icon field-icon icofont-waiter-alt"></i></div>
    ...
    <div class="input-group mt-2">
        <div class="input-group-text"><i class="input-icon field-icon icofont-ui-touch-phone"></i></div>
        <input type="text" class="form-control" name="phone" autocomplete="off" placeholder="{{__('Phone')}}">

        <span class="invalid-feedback error error-phone"></span>
    </div>
    <div class="input-group mt-2">
        <div class="input-group-text"><i class="input-icon field-icon icofont-mail"></i></div>
        <input type="email" class="form-control" name="email" autocomplete="off" placeholder="{{__('Email address')}}">

        <span class="invalid-feedback error error-email"></span>
    </div>
    <div class="input-group mt-2">
        <div class="input-group-text"><  <i class="input-icon field-icon icofont-ui-password"></i></div>
    ...
    <div class="c-grey f14 text-center">
       {{__(" Already have an account?")}}
        <a data-target="#login" data-toggle="modal">{{__("Log In")}}</a>
    </div>
</form>

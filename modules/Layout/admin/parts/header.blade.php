<?php
$user = Auth::user();
[$notifications,$countUnread,$page] = getNotify();
...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="{{route('admin.index')}}"><img height="35" src="http://127.0.0.1:8000/uploads/0000/1/2023/04/08/02.png" alt="Midlands"></a></h3>
</div>
                ...
                <ul class="dropdown-list-items p-0 m-0">
                    @if(count($notifications)> 0)
                        ...
                        if(empty($oneNotification->read_at)){
                            ...
                            //$services = @$usingData->type;
                            //$idServices = @$usingData->id;
                            $title = $oneNotification->message;
                            $name = $oneNotification->message;
                            $avatar = auth()->user()->avatar;
                            $link = $oneNotification->url;
                        }

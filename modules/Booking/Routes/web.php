...
Route::group(['prefix'=>config('booking.booking_route_prefix')],function(){
    ...
    Route::get('/{code}','BookingController@detail')->name('booking.booking_details_email');
    ...
    Route::post('/pay-now','BookingController@payNow')->name('booking.payNow');
    ...
    Route::get('/append/{booking}','BookingController@append')->name('booking.append');
});

<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>{{__("Auto Apply")}} </label>
                    <select class="form-control" name="auto_apply">
                        <option @if($row->auto_apply === 0) selected @endif value="0">{{__("No")}}</option>
                        <option @if($row->auto_apply === 1) selected @endif value="1">{{__("Yes")}}</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>Partner Apply </label>
                    <select class="form-control" name="is_partner">
                        <option @if($row->is_partner === 0) selected @endif value="0">{{__("No")}}</option>
                        <option @if($row->is_partner === 1) selected @endif value="1">{{__("Yes")}}</option>
                    </select>
                </div>
            </div>
        </div>

...
class Coupon extends BaseModel
{
    ...
    public function applyCouponValidate($booking,$action){
        ...
        $check_coupon = CouponBookings::where('coupon_code',$this->code)->where('is_partner',0)->where("booking_id",$booking->id)->count();
    ...
    public function add($booking)
    {
        ...
        if($this->discount_type == 'percent'){
            $coupon_amount =  $booking->getTotalBeforeExtraPriceAttribute() / 100 * $this->amount;
        }

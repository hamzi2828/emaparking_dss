            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Default Pricing Plan")}}</label>
                        <select name="plan_id" required class="form-control">
                            <option disabled selected>Default pricing plan</option>
                            @foreach($plans as $plan)
                                <option @if($row->plan_id == $plan->id) selected @endif value="{{$plan->id}}">{{$plan->name}}</option>
                            @endforeach
                        </select>
...
<!--                <div class="col-lg-6">
                ...
                <div class="col-lg-6 d-none">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" name="max_guests" class="form-control" value="1" >
                    </div>
                </div>
            </div>
        @endif
                        ...
                        @foreach($service_fee as $key=>$item)
                            <div class="item" data-number="{{$key}}">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select name="service_fee[{{$key}}][type]" class="form-control">

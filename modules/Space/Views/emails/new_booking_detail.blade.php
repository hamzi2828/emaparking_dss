...
<div class="b-table-wrap">
    <table class="b-table" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="val">#{{$booking->reference_no}}</td>
        </tr>
        <tr>
        ...
        @endif
        <tr>
            <td class="label">{{__('Directions')}}</td>
            <td class="val">
                <span style="font-size: small">Click the link below to see details about directions:</span><br>
        ...
        <tr>
            ...
            <tr>
                <td class="label">{{__('Arrival date and time')}}</td>
                <td class="val">{{display_datetime($booking->start_date)}}</td>
            </tr>
            <tr>
                <td class="label">{{__('Return date and time')}}</td>
                <td class="val">
...
<div class="text-center mt20">
   <a href="{{ route("booking.booking_details_email",[$booking->code]) }}" target="_blank" class="btn btn-primary manage-booking-btn">{{__('Booking Details')}}</a>
</div>

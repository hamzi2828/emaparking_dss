...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::post('/booking-history/cancel','UserController@cancelBooking')->name('user.booking.cancel');
    Route::post('/booking-history/cancel/update','UserController@updateCancellation')->name('user.booking.cancel.update');
    Route::post('/booking-history/update','UserController@amendBooking')->name('user.booking.amend');
    Route::post('/booking-history/update/admin','UserController@updateAmendment')->name('user.booking.amend.update');
    ...
    Route::get('referrals','ReferralController@index')->name('user.referrals');
    Route::get('wallet_old',function() {
        return redirect()->route('user.wallet.index');
    })->name('user.wallet');
    Route::get('wallet','WalletController@wallet')->name('user.wallet.index');
    Route::get('wallet/transactions','WalletController@wallet_transactions')->name('user.wallet.transactions');

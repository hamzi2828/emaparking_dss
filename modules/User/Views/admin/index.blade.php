...
{{--                            <th class="status">{{__('Status')}}</th>--}}
                        ...
                        @foreach($rows as $row)
                            <tr>
                                ...
                                <td>{{$row->phone}}</td>
                                <td>
                                    {{$row->role!= null && $row->role->name=='customer' && $row->booking_agent ? 'booking agent' : ($row->role->name?? '')}}
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a href="{{route('user.admin.wallet.report',['id'=>$row->id])}}" class="dropdown-item"><i class="fa fa-money"></i> {{__("Credit Report")}}</a>

(function ($) {
    "use strict"
    new Vue({
        el:'.bravo_space_book_app_'+bravo_booking_data.id,
        data:{
            id:'',
            extra_price:[],
            person_types:[
            ...
            var options = {
                ...
                isInvalidDate:function (date) {
                    for(var k = 0 ; k < me.allEvents.length ; k++){
                        ...
                        if(item.start == date.format('MM/DD/YYYY')){
            ...
            this.$nextTick(function () {
                ...
                $(this.$refs.start_date).daterangepicker(options).on('apply.daterangepicker',
                    function (ev, picker) {
                        ...
                        me.start_date = picker.startDate.format('MM/DD/YYYY');
                        me.end_date = picker.endDate.format('MM/DD/YYYY');

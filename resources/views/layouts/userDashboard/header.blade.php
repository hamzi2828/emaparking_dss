    ...
    <div class="container-xxl d-flex align-items-center">
      ...
      <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
        <a href="../dist/index.html">
          <img alt="Logo" src="https://emaparking.co.uk/uploads/0000/1/2023/04/08/02.png" class="h-15px h-lg-40px logo-default" />
          <img alt="Logo" src="https://emaparking.co.uk/uploads/0000/1/2023/04/08/02.png" class="h-15px h-lg-40px logo-sticky" />
        </a>
      </div>
      <!--end::Header Logo-->
      <!--begin::Wrapper-->
        ...
        <div class="d-flex align-items-stretch" id="kt_header_nav">
          ...
          <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
            ...
            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
              <div class="menu-item {{Route::is('vendor.dashboard') ? 'here' : ''}} me-lg-1">
                <a class="menu-link py-3" href="{{route('vendor.dashboard')}}">
                  <span class="menu-title">Dashboard</span>
                </a>
              </div>
              <div class="menu-item {{Route::is('user.booking_history') ? 'here' : ''}} me-lg-1">
                <a class="menu-link py-3" href="{{route('user.booking_history')}}">
              ...
              <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{Route::is('user.wallet.*') ? 'here' : ''}} menu-lg-down-accordion me-lg-1">
                <span class="menu-link py-3">
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                  <div class="menu-item">
                    <a class="menu-link {{Route::is('user.wallet.index') ? 'active' : ''}} py-3" href="{{route('user.wallet.index')}}">
                  ...
                  <div class="menu-item">
                    <a class="menu-link py-3 {{Route::is('user.wallet.transactions') ? 'active' : ''}} " href="{{route('user.wallet.transactions')}}">
                      <!--title="Check out the complete documentation" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">-->
                      <span class="menu-icon">
                  ...
                  <div class="menu-item">
                    <a class="menu-link py-3 {{Route::is('user.wallet.buy') ? 'active' : ''}} " href="{{route('user.wallet.buy')}}">
                      <!--title="Check out the complete documentation" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">-->
                      <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                        <span class="svg-icon svg-icon-2">
              ...
              <div class="menu-item {{Route::is('user.referrals') ? 'here' : ''}} me-lg-1">
                <a class="menu-link py-3" href="{{route('user.referrals')}}">
        ...
        <div class="d-flex align-items-stretch flex-shrink-0">
          ...
          <div class="topbar d-flex align-items-stretch flex-shrink-0">
            ...
            <div class="d-flex align-items-center ms-1 ms-lg-3">
              ...
              <!--begin::Menu-->
              <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" position: relative ">
                              <!--begin::Heading-->
              ...
              <!--end::Tab content-->
              <div class="overlay ">
                <div> We are working on notifications... </div>
              </div>
            </div>
            <!--end::Menu-->
            <!--end::Menu wrapper-->
          ...
          <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
              <img alt="Pic" src="{{auth()->user()->getAvatarUrl()}}" />
            </div>
            <!--begin::Menu-->
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-5">
                <a href="{{route('user.wallet.index')}}" class="menu-link px-5">
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-5">
                <a href="{{route('user.referrals')}}" class="menu-link px-5">
                  <span class="menu-text">My Referrals</span>
                </a>
              </div>
              <!--end::Menu item-->
              <!--begin::Menu item-->
              ...
              <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                <a href="#" class="menu-link px-5">
                  <span class="menu-title position-relative">Language <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">English <img class="w-15px h-15px rounded-1 ms-2" src="assets/media/flags/united-kingdom.svg" alt="" />
                    </span>
                  </span>
                </a>
                <!--begin::Menu sub-->
              ...
              <div class="menu-item px-5">
                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form-vendor').submit();" class="menu-link px-5">Sign Out</a>
              </div>
              <!--end::Menu item-->
              <!--begin::Menu separator-->
              <!--<div class="separator my-2"></div>
                      ...
                      <div class="menu-item px-5"><div class="menu-content px-5"><label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="kt_user_menu_dark_mode_toggle"><input class="form-check-input w-30px h-20px" type="checkbox" value="1" name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="../dist/index.html" /><span class="pulse-ring ms-n1"></span><span class="form-check-label text-gray-600 fs-7">Dark Mode</span></label></div></div>-->
              <!--end::Menu item-->
            </div>
            <!--end::Menu-->
            <!--end::Menu wrapper-->
